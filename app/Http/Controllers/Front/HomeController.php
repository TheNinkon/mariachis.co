...
class HomeController extends Controller
{
    ...
    public function __invoke(): View
    {
        ...
        $publishedFilter = fn ($query): mixed => $query->published();
        ...
        $searchCities = $this->buildSearchLocationTree($publishedProfiles);
        if ($searchCities->isEmpty()) {
            $searchCities = $this->buildSearchLocationFallback($cityShowcase);
        }
