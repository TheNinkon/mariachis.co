  ...
  <div class="card mb-6">
    <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-3">
      <div>
        ...
        <p class="mb-0 text-muted">Monitorea el estado de los cobros de Wompi antes de habilitar o revisar accesos del panel partner.</p>
      </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                  <div class="bg-lighter rounded p-3 h-100">
                    <div class="small text-muted">Checkout</div>
              ...
              @if($payment->provider_transaction_id)
                <p class="mb-3 small text-muted">
                  Transaccion Wompi:
                  <strong>{{ $payment->provider_transaction_id }}</strong>
                  · Estado proveedor:
                  <strong>{{ $payment->provider_transaction_status ?: '-' }}</strong>
                </p>
              ...
              @if($payment->status === \App\Models\AccountActivationPayment::STATUS_PENDING_REVIEW)
                <div class="row g-3">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <form method="POST" action="{{ route('admin.account-activation-payments.update', $payment) }}">
                      ...
                      <button type="submit" class="btn btn-outline-danger btn-sm mt-2">Rechazar cobro</button>
                    </form>
                  </div>
                </div>
              @endif
