...
aria-pressed="true">
                <span><i class="icon-base ti tabler-moon-stars icon-md me-3" data-icon="moon-stars"></i>Oscuro</span>
              </button>
            </li>
            <li>
...
data-icon="device-desktop-analytics"></i>Sistema</span>
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{ Route::has('client.login') ? route('client.login') : url('/login') }}" class="btn btn-primary"><span
              class="icon-base ti tabler-login scaleX-n1-rtl me-md-1"></span><span
              class="d-none d-md-block">Iniciar sesión / Registro</span></a>
        </li>
        <!-- navbar button: End -->
      </ul>
      <!-- Toolbar: End -->
