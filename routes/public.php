...
use App\Http\Controllers\Front\HtmlSitemapController;
...
Route::domain($publicHost)->group(function () use (
    ...
    Route::redirect('/explorar', '/mapa-del-sitio', 301);
    Route::get('/mapa-del-sitio', [HtmlSitemapController::class, 'show'])->name('seo.html-sitemap');
    ...
    Route::get('/categorias/servicios/{serviceType:slug}', [HomeController::class, 'redirectToServiceCategory'])->name('home.service-category.redirect');
    Route::get('/categorias/grupos/{groupSizeOption:slug}', [HomeController::class, 'redirectToGroupSizeCategory'])->name('home.group-size-category.redirect');
    Route::get('/categorias/presupuestos/{budgetRange:slug}', [HomeController::class, 'redirectToBudgetCategory'])->name('home.budget-category.redirect');
